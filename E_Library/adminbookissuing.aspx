<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="E_Library.WebForm6" %>
						...
						<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="End Date" TextMode="Number"></asp:TextBox>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-6">
									<asp:Button ID="Button2" class="btn btn-lg btn-block btn-primary" runat="server" Text="Deposite" OnClick="Button2_Click" />
								</div>
								<div class="col-6">
									<asp:Button ID="Button4" class="btn btn-lg btn-block btn-success" runat="server" Text="Withdrew" OnClick="Button4_Click" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="row">
											<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:E_LibraryConnectionString6 %>' SelectCommand="SELECT * FROM [book_issue_tbl]" ProviderName="<%$ ConnectionStrings:E_LibraryConnectionString6.ProviderName %>">
											</asp:SqlDataSource>
											<div class="col">
